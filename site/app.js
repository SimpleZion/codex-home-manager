...
const copy = {
  zh: {
    ...
    deployTitle: "上线目标",
    deployText: "静态公开站点已部署到 Cloudflare Pages。simplezion.com 子域名绑定需要 DNS 记录生效后启用；核心维护引擎仍只在本地私有环境运行。",
  ...
  en: {
    ...
    deployText: "The static public site is deployed to Cloudflare Pages. The simplezion.com subdomain will be enabled after the DNS record is active; the core maintenance engine remains local and private.",
    footer: "Public preview. Private local engine excluded.",
