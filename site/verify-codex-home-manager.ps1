...
$filePath = Join-Path $env:USERPROFILE "Downloads\codex-home-manager-local-win-x64-v1.0.4-b6d12a23132f.exe"
$expectedSha256 = "b6d12a23132fdbd2d05b6af7a6e32960393dec885fb32361a49ea4f5fb53e806"
